...
foreach (array_keys($row) as $key){
    $count=$count+1;
    if ($count == 2){echo "<tr><th scope='row'>"; echo $row[$count-1];
      echo "</th>"};
    if ($count == 3){echo "<td>$row[$key]</td>"; $amount=$row[$key]};
    if ($count == 4){echo "<td>if($amount>$row[$key]"){echo "<td>&#9989;</td></tr>"; $counter=0;}else{echo "<td>&#10060;</td></tr>"; $counter=0;}};
};
};
